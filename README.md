# ADSuyiSdk Android Sdk——接入文档 V3.9.0.01171
...
| Name      | 容量   | 版本号              | MD5值                            |
| --------- | ----- | ------------------ | -------------------------------- |
| tianmu    | 2.06M | v2.2.0.02021       | f3b5623492c1fafa2040bc8933857bdd |
...
dependencies {
    ...
    // 天目AdapterSdk，必选的
    implementation 'cn.admobiletop.adsuyi.ad.adapter:tianmu:2.2.0.02021'
