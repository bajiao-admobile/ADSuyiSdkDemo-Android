# ADSuyiSdk Android Sdk——接入文档 V3.7.8.08182
...
| Name         | 大小   | 版本号         | MD5值                            |
| ------------ | ----  | ------------- | -------------------------------- |
| ADSuyi基础包  | 0.37M | V3.7.8.08182  | 70139c6311503e401c0748c4e3b7b1be |
| OAID         | 1.10M | V1.0.25       | —                                |
...
dependencies {
    ...
    // ADSuyiSdk核心库必须导入
    implementation 'cn.admobiletop.adsuyi.ad:core:3.7.8.08182'
