# ADSuyiSdk Android Sdk——接入文档 V3.7.8.08183
...
| Name         | 大小   | 版本号         | MD5值                            |
| ------------ | ----  | ------------- | -------------------------------- |
| ADSuyi基础包  | 0.37M | V3.7.8.08183  | b3e2c89fd0a779b9bd725946d3de4450 |
| OAID         | 1.10M | V1.0.25       | —                                |
...
dependencies {
    ...
    // ADSuyiSdk核心库必须导入
    implementation 'cn.admobiletop.adsuyi.ad:core:3.7.8.08183'
