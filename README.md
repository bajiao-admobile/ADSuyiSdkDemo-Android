# ADSuyiSdk Android Sdk——接入文档 V3.7.8.08184
...
| Name         | 大小   | 版本号         | MD5值                            |
| ------------ | ----  | ------------- | -------------------------------- |
| ADSuyi基础包  | 0.37M | V3.7.8.08184  | c647d8de086e86352f6caf1a28d02dcf |
| OAID         | 1.10M | V1.0.25       | —                                |
...
dependencies {
    ...
    // ADSuyiSdk核心库必须导入
    implementation 'cn.admobiletop.adsuyi.ad:core:3.7.8.08184'
