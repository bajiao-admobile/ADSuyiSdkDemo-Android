 ...
 * @date 2020/10/21
 */
public class NativeExpressAdapterInterstitialAdDialog extends BaseNativeInterstitialDialog {

    public NativeExpressAdapterInterstitialAdDialog(@NonNull Context context) {
        super(context);
    ...
    public void render(ADSuyiNativeAdInfo adSuyiNativeAdInfo) {
        ...
        if(adSuyiNativeAdInfo instanceof ADSuyiNativeExpressAdInfo) {
            ...
            if (nativeExpressAdInfo == null) {
                Log.d(TAG, "ADSuyiNativeExpressAdInfo is null");
                return;
            }
